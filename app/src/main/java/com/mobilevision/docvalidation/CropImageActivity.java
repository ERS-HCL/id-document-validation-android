...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnGetCroppedImageCompleteListener  {
    ...
    /**
     * Display a toast message on crop failed scenario and set the intent result to {@link #RESULT_CANCELED}
     */
    ...
    /**
     * Save the bitmap image to storage and return the absolute storage path.
     * @param context
     * @param bitmapImage
     * @return imagePath
     * @throws IOException
